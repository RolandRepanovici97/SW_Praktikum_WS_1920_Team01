...
/**
 * Diese Klasse erweitert das VerticalPanel und wird benötigt, um eine neue Umfrage anzulegen.
 * @author alina
 *
 */
public class UmfrageErstellenForm extends VerticalPanel {
	...
	/**
	 * Diese Nested Class implementiert das Interface AsyncCallBack und ermöglicht die Rückgabe der Filmobjekte.
	 * @author alina
	 */
	...
	/**
	 * Diese Nested Class implementiert das Interface ClickHandler und ermöglicht in Interaktion mit dem Nutzer:
	 * Wenn der Nutzer die Felder ausgfüllt hat, dann wird eine neue Umfrage erstellt. Die Eingaben des Nutzers stellen die 
	...
	private class ErstellenClickHandler implements ClickHandler {
		...
		public void onClick(ClickEvent event) {
			...
			if (umfragenametext!= null && gruppebox!= null && filmbox!= null && datumwähler!= null) {
				...
				KinoBesuchsplanungAsync kinobesuchsplanung = ClientSideSettings.getKinobesuchsplanung();
				//Aufruf der Methode createUmfrage: Hierdurch wird implizit das neue Umfrageobjekt in der DB gespeichert
				kinobesuchsplanung.createUmfrage(umfrage.getUmfragenname(), new UmfrageCallback());
